...
function getResultMessage(score) {
    if (score >= 4.5) return "Отличный результат! Вы прекрасно разбираетесь в метриках";
    if (score >= 3.5) return "Хороший результат! Есть что подтянуть";
    if (score >= 2.5) return "Неплохо, но стоит повторить материал";
